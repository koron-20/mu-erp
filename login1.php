...
<body class="bg-sky-100 roboto">
  ...
  <main>
    <div class="flex flex-row justify-center space-x-10  mt-8 mr-36 mb-28 ml-80 max-w-3xl h-max rounded-2xl shadow-2xl bg-sky-500">
      <div>
      ...
      <div class="pr-16">
        ...
        <form class="space-y-2" action="" method="post">
          ...
          <h4 class="ml-12 mb-3 white">Forgot password?</h4>
          <a href=""><button class="bg-blue-600 hover:bg-blue-800 p-2 rounded-xl white ml-14 mb-3" name="login" id="login">Login</button></a>
          <h3 class="text-white mb-14 ml-5">New user? <span><a class="text-cyan-50 text-lg" href="rgister1.php">Register</a></span> </h3>
        </form>  
