  ...
  if(isset($_POST['submit'])){
    ...
    if($fileType != "pdf"){
      ...
      if(move_uploaded_file($_FILES["pdfFile"]["tmp_name"], $targetFile)){
        ...
        $duplicate = mysqli_query($conn, "SELECT * FROM `exmschedule` WHERE id='$id'");
        ...
        if(mysqli_num_rows($duplicate) > 0){
          ...
          $sql = "INSERT INTO `exmschedule` (`id`, `filename`, `foldername`) 
        ...
        <form class="space-y-5" action="" method="post" enctype="multipart/form-data">
          <div>
            ...
            <p class="text-white font-semibold">Enter Semester</p>
              <input class="rounded-lg" type="text" name="id" id="id" placeholder="Spring-2024 ">
          </div>
          <div>
