...
<body class="robot">
  ...
  <div class="flex flex-col space-y-36">
    ...
    <div class="space-y-5  ml-[580px] w-[500px] bg-gradient-to-r from-indigo-800 via-sky-600 to-cyan-500  text-center p-10 rounded-xl shadow-2xl">
      <div>
        <h1 class="white font-bold text-xl mb-5">Download Question Bank</h1>
        <select class="rounded-lg mb-2 p-1 text-gray-400" name="" id="">
          <option value="">Phy-1</option>
